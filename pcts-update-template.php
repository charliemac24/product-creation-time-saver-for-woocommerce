...
echo "<input type=\"text\" name=\"pcts_template_name\" class=\"pcts_template_name\" value=\"template name\" placeholder=\"".esc_attr(__('Enter Template Name','product-creation-time-saver-for-woocommerce'))."\"/>";
echo "</div>";		
